...
const Middle = () => {
  const glowingStyle = css`
    ...
    font-size: 100px;
    font-weight: bold;
    text-shadow: 0 0 5px gold, 0 0 10px gold, 0 0 20px gold, 0 0 40px gold, 0 0 80px gold;
  ...
  return (
    <div>
      ...
      <Text color="white" fontWeight="bold" fontSize="100px">
        Earn <Text as="span" css={glowingStyle} fontSize="100px">4.65%</Text> APY <br /> on your cash
      </Text>
      <Text color="white" fontSize="30" mt={4}>
        Earn more than ever on your uninvested cash, FDIC-insured up to <br /> $2 million*. Your first 30 days are free, then it’s just $5 a month.
      </Text>
    ...
    <Box display="flex" bg='#7fff00' p={10} alignItems="center" mt={2}>
        ...
        <Box flex="2" textAlign="left">
          ...
          <Text color="black" fontSize="45px" mb={4}>
            Build your <br/> portfolio starting <br/> with just $1<br />
          </Text>
          <Text>Invest in stocks, options, and ETFs at your pace <br/> and commission-free.</Text>
          <Text color="black">
            <Icon as={AiFillWarning} boxSize={6} mr={2} />
      ...
      <Text color="white" fontSize="50px" mb={-2} lineHeight="1.1">
          ...
          <Text color="white">Invest in stocks, options, and ETFs at your pace <br/> and commission-free.</Text>
          <Text color="white">
            <Icon as={AiFillWarning} boxSize={6} mr={2} />
            Investing Disclosures
          </Text>
